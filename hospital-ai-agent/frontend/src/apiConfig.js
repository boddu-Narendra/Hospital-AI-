 ...
 *
 * In production (e.g. deployed on Vercel), it routes to https://hospital-ai-agent-api.onrender.com
 * (or whatever value is set in VITE_BACKEND_URL).
 */

const rawBackendUrl =
  import.meta.env.VITE_BACKEND_URL ||
  (import.meta.env.PROD ? "https://hospital-ai-agent-api.onrender.com" : "");
